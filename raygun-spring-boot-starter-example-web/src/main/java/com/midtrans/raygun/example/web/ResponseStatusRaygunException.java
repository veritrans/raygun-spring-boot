 ...
 * handled by the {@link ResponseStatusExceptionResolver}.
 *
 * @author Raydhitya Yoseph
 */
@ResponseStatus(code = HttpStatus.BAD_GATEWAY, reason = "Bad Gateway")
class ResponseStatusRaygunException extends RaygunException {
  private static final long serialVersionUID = -4988021335413518793L;
}
